...
MODEL_PRETRAINED=${MODEL_PRETRAINED:-"/path/to/model_checkpoints/Dream-v0-Instruct-7B"}
MODEL_LORA_PATH_DEFAULT=${MODEL_LORA_PATH_DEFAULT:-"/path/to/model_checkpoints/D2F_Dream_v0_Instruct_LoRA"}
